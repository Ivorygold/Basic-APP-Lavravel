  ...
  <section class="standard__blog">
      <div class="container">
          <div class="row">
              ...
              @foreach($allBlogs as $items)
                  <div class="standard__blog__post">
                      <div class="standard__blog__thumb">
                          <a href="blog-details.html"><img src="{{asset($items->blog_image)}}" alt=""></a>
                      ...
                      <div class="standard__blog__content">
                          <div class="blog__post__avatar">
                              <div class="thumb"><img src="{{asset($items->blog_image)}}" alt=""></div>
                              <span class="post__by">By : <a href="#">Halina Spond</a></span>
                          </div>
                          <h2 class="title"><a href="{{route('blog.details', $items->id)}}">{{ $items->blog_title }}</a></h2>
                          <p> {!!($items->blog_description) !!} </p>
                              <li><i class="fal fa-calendar-alt"></i> {{Carbon\Carbon::parse($items->created_at)->diffForHumans()}}</li>
                  ...
                  <aside class="blog__sidebar">
                      ...
                      <div class="widget">
                          ...
                          @foreach($categories as $catItems)
                              <li class="sidebar__cat__item"><a href="{{route('category.blog', $catItems->id)}}">{{ $catItems->blog_category }}</a></li>
                              @endforeach
