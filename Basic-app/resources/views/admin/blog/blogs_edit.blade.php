    ...
    <input type="hidden" name="id" value="{{$blogs->id}}">
                  ...
                  <div class="row mb-3">
                      ...
                      <select name="blog_category_id" class="form-select" aria-label="Default select example">
                            ...
                            <option value="{{$CatItem->id}}" {{$CatItem->id == $blogs->blog_category_id ? 'selected': '' }}>{{$CatItem->blog_category}}</option>
                            @endforeach
                            </select>
                      </div>
                  </div>
                  ...
                  <div class="row mb-3">
                      ...
                      <div class="col-sm-10">
                      <textarea id="elm1" name="blog_description" type="text">{{$blogs->blog_description}}</textarea>
                      </div>
                  </div>
                  <!-- end row -->
