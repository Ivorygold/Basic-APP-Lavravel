...
<html lang="en">
    ...
    <body class="auth-body-bg">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        @csrf
                                ...
                                <strong> Forgot your password? No problem.</strong> Just let us know your email address and we will email you a 
        ...
        <!-- JAVASCRIPT -->
        <script src="{{asset('backend/assets/libs/jquery/jquery.min.j')}}s"></script>
